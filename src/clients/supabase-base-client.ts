...
export class SupabaseBaseClient {
  private readonly _withSoftDelete: string[];

  constructor(
    @Inject(SUPABASE_CLIENT) private readonly _client: SupabaseClient,
    @Inject(SUPABASE_OPTIONS) private readonly options: SupabaseModuleOptions,
  ) {
